...
<div class="panel-group col-sm-2" id="szdx_sidebar_left" role="tabist" aria-multiseletable="true">
    <ul class="nav nav-pills nav-stacked emp-sidebar">
...
<script type="text/javascript">
    ...
    $(".emp_info").click( function(){
        $(this).attr("href","/szdx/emp/getEmpList");
    })
    /*跳转到部门页面*/
    $(".dept_info").click(function(){
        $(this).attr("href","/szdx/dept/getDeptList");
    })
    /*员工清零这个功能暂未实现*/
    $(".emp_clearall_btn").click(function(){
        alert("对不起，您无权限进行操作！请先获取权限");
    })
    /*部门清零这个功能暂未实现*/
